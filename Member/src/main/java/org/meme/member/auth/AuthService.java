...
import org.meme.domain.artist.entity.Artist;
import org.meme.domain.artist.entity.ArtistRepository;
import org.meme.domain.dto.AuthRequest;
import org.meme.domain.dto.AuthResponse;
import org.meme.domain.enums.Provider;
import org.meme.domain.model.entity.Model;
import org.meme.domain.model.entity.ModelRepository;
import org.meme.domain.token.entity.Token;
import org.meme.domain.user.entity.User;
import org.meme.domain.user.entity.UserRepository;
import org.meme.member.converter.TokenConverter;
import org.meme.member.converter.UserConverter;
import org.meme.member.exception.AuthException;
import org.meme.member.infra.RedisRepository;
import org.meme.member.jwt.JwtTokenProvider;
import org.meme.member.oauth.provider.apple.AppleAuthProvider;
import org.meme.member.oauth.provider.kakao.KakaoAuthProvider;
import org.springframework.security.authentication.*;
import org.springframework.security.core.Authentication;
import org.springframework.security.core.context.SecurityContextHolder;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import org.meme.member.oauth.provider.OAuthProvider;

import java.util.Optional;

import static org.meme.domain.enums.Provider.APPLE;
import static org.meme.domain.enums.Provider.KAKAO;
import static org.meme.member.common.status.ErrorStatus.*;
...
public class AuthService {
    ...
    protected String resolveToken(String bearerToken) {
        if (bearerToken == null || !bearerToken.startsWith(TOKEN_PREFIX))
            throw new AuthException(JWT_TOKEN_UNSUPPORTED);
    ...
    protected void checkNicknameLessThanMaxLength(String nickname) throws AuthException {
        if (nickname.length() > MAX_LENGTH_NICKNAME)
            ...
            throw new AuthException(NICKNAME_NOT_EXIST);
    }
